...
const Landing = () => {
  ...
  return (
    <>
      <div className={`z-10 transition-all duration-500 ease-in ${transitioning ? "translate-y-full" : ""} flex flex-col justify-between items-center w-auto h-3/4 mx-2`}>
        ...
        }} className="bg-blue-800/40 z-40 border-solid border-2 border-white rounded-full md:mt-12 w-24 h-16 text-xl text-white">Start</button>
      </div>
      <div className="h-2/3 w-full -mt-32">

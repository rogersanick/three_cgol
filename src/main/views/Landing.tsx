...
const Landing = (props: LandingProps) => {
  ...
  return (
    <div className={`bg-slate-800 transition-all duration-500 ease-in ${transitioning ? "translate-y-full" : ""} flex flex-col items-center h-screen w-full`}>
      <div className="container flex flex-col md:items-center h-2/3 w-screen mx-6 px-6 max-w-[60rem]">
